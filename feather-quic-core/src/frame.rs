...
impl QuicFrame {
        ...
        W: Write + Seek + Read,
    {
        ...
        match self {
            ...
            QuicFrame::Stream(stream_frame) => {
                ...
                trace!(
                    "Quic Stream Frame type_bits: 0x{:x}, stream_id: {}, offset: {}, length: {}",
                    type_bits,
        ...
        while (cursor.position() as usize) < pbuf.len() {
            ...
            match frame_type {
                ...
                QuicFrameType::StreamsBlocked => {
                    Self::handle_streams_blocked_frame(&mut cursor, qconn, frame_type_val as u8)?
                }
    ...
    fn handle_max_streams_frame(
        ...
        //   Maximum Streams (i),
        // }
        let span = info_span!("handle_max_streams_frame", type_bits = ?type_bits);
        let _enter = span.enter();
