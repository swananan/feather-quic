...
impl QuicStream {
    ...
    pub(crate) fn consume_send_queue(&mut self) -> Option<(Option<Vec<u8>>, u64, u64, bool)> {
        let span = span!(
            Level::TRACE,
        ...
        match self.send_queue.take() {
            Some(send_queue) => {
                ...
                let send_len = send_queue.len() as u64;
                // if *connection_limit < send_queue.len() as u64 {
                ...
                //     tmp
                // } else {
                //     *connection_limit -= send_queue.len() as u64;
                ...
                info!(
                    ...
                    self.stream_id, offset, send_len, fin,
                );
